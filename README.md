...
├─ script.js         # 스크립트 (현재 정적)
├─ images/           # 이미지·아이콘
│  ├─ hero-workshop.png   # 회사소개 작업 현장 사진
│  ├─ card-equipment.png  # 제작 장비 카드 사진
│  ├─ card-materials.png  # 부자재 카드 사진
│  └─ card-computer.png   # 작업 환경 카드 사진
├─ README.md         # 이 문서
└─ .gitignore        # Git 제외 목록
```
...
- 전화번호(010-5201-7977)와 상호명("에어사인 프로")은 실제 정보로 확인 후 사용하세요.
